...
class Mixer:
    ...
    def selected_sound(self):
        selected_sound = pygame.mixer.Sound('apps/Optics/sounds/metsej/metsej_1.wav')
        selected_sound.set_volume(self.actionvolume)
        selected_sound.play()
        pass

    def placed_sound(self):
        placed_sound = pygame.mixer.Sound('apps/Optics/sounds/metsej/metsej_2.wav')
        placed_sound.set_volume(self.actionvolume)
        placed_sound.play()
        pass

    def clicked_sound(self):
        clicked_sound = pygame.mixer.Sound('apps/Optics/sounds/metsej/metsej_1.wav')
        clicked_sound.set_volume(self.actionvolume)
        clicked_sound.play()
        pass

    def laser_sound(self):
        laser_sound = pygame.mixer.Sound('apps/Optics/sounds/metsej/metsej_2.wav')
        laser_sound.set_volume(self.objectvolume)
        laser_sound.play()
        pass

    def destroy_sound(self):
        destroy_sound = pygame.mixer.Sound('apps/Optics/sounds/explosion.wav')
        destroy_sound.set_volume(self.objectvolume)
        destroy_sound.play()
        pass

    def achievement_sound(self):
        achievement_sound = pygame.mixer.Sound('apps/Optics/sounds/metsej/metsej_3.wav')
        achievement_sound.set_volume(self.achievementvolume)
        achievement_sound.play()
        pass

    def soundtrack(self):
        pygame.mixer.music.load('apps/Optics/sounds/mc.mp3')
