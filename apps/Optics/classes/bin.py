import pygame
from apps.Optics.classes import gameobjects as go
from apps.Optics.classes import parkinson as particles, achievements, color_picker
import random
from apps.Optics.classes import light
...
class Bin:
    ...
    def __init__(self, game):
        ...
        self.bin_img = pygame.image.load("apps/Optics/images/trash1.png")
